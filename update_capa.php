  ...
  $pasta ='Fotos/Capa/'; //Pasta onde a imagem será salva

  $permiti  = array('jpg', 'jpeg', 'png');
  $name = uniqid().'.'.$ext; $uid = uniqid();

  $resultado = $Obj_Conexao->Consulta("UPDATE pomber SET capa = '$name' WHERE username = '".$_SESSION['usuario']."' OR email = '".$_SESSION['usuario']."'");
  ...
  resize_crop_image(450, 300, $pasta.'/'.$name, $pasta.'/'.$name);
